...
import { Grid, Row, Col, Form, FormGroup,  ControlLabel, Button, ButtonGroup } from 'react-bootstrap'
    ...
    return (
      <Col xs={8}  offset={2}>
        <Grid className="admin-control-bar">
          <ButtonGroup>
            <Button size="lg" onClick={this.onClickBtnAddCourse}    bsStyle="success">Nowy test</Button>
            <Button size="lg" onClick={this.onClickBtnAddQuestion}    bsStyle="info">Nowe pytanie</Button>
          </ButtonGroup>
        </Grid>
      </Col>
    )
